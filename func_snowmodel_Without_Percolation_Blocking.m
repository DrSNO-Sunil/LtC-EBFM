...
function [A] = func_snowmodel_Without_Percolation_Blocking(C,A,clim,dt,grid,time,phys)
...
if  percolation == 0        % no deep percolation - surface layer only
    carrot(:,1) = 1;
    carrot(:,2:end) = 0;
elseif  percolation == 1
% if  percolation == 1
    carrot(:,1) = 1;
